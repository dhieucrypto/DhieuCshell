-- [[ CSHELL HUB PREMIUM v4 - NO CACHE VERSION ]] --
repeat wait() until game:IsLoaded()
print("--- CSHELL v4 STARTING ---")
...
local function LoadMainHub()
    ...
    Title.Parent = MainFrame; Title.Text = "CSHELL HUB v4 PRO"; Title.Font = Enum.Font.GothamBold; Title.TextColor3 = Color3.fromRGB(255, 255, 255); Title.TextSize = 28; Title.Size = UDim2.new(1, 0, 0, 60); Title.BackgroundTransparency = 1; MakeDraggable(Title, MainFrame)
...
local function LoginUI()
    ...
    T.Parent = Main; T.Text = "CSHELL LOGIN v4"; T.Font = Enum.Font.GothamBold; T.TextColor3 = Color3.fromRGB(255, 255, 255); T.TextSize = 35; T.Size = UDim2.new(1, 0, 0, 80); T.BackgroundTransparency = 1; MakeDraggable(T, Main)
