-- [[ CSHELL HUB PREMIUM - STABLE VERSION ]] --
...
local function LoadMainHub()
    ...
    MakeDraggable(Title, MainFrame) -- Chỉ nắm tiêu đề để kéo
    ...
    Instance.new("UICorner", Toggle).CornerRadius = UDim.new(1, 0); MakeDraggable(Toggle, Toggle)
...
local function LoginUI()
    ...
    MakeDraggable(T, Main) -- Chỉ nắm tiêu đề để kéo
