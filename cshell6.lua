-- [[ CSHELL HUB PREMIUM v6 - BERSERKER VERSION ]] --
repeat wait() until game:IsLoaded()
print("--- CSHELL v6 STARTING ---")
    ...
    pcall(function()
        ...
        if not char:FindFirstChildOfClass("Tool") then
            for _, v in pairs(LocalPlayer.Backpack:GetChildren()) do
                if v:IsA("Tool") and (v.ToolTip == "Melee" or v.ToolTip == "Sword" or v.Name == "Combat") then
        ...
        if _G.AutoFarm then
            pcall(function()
                ...
                if not LocalPlayer.PlayerGui.Main.Quest.Visible then
                    ...
                    if target then
                        AutoEquip()
                        LocalPlayer.Character.HumanoidRootPart.CFrame = target.HumanoidRootPart.CFrame * CFrame.new(0, 8, 0)
                    else
...
local function LoadMainHub()
    ...
    Title.Parent = MainFrame; Title.Text = "CSHELL HUB v6 BERSERKER"; Title.Font = Enum.Font.GothamBold; Title.TextColor3 = Color3.fromRGB(255, 255, 255); Title.TextSize = 28; Title.Size = UDim2.new(1, 0, 0, 60); Title.BackgroundTransparency = 1; MakeDraggable(Title, MainFrame)
...
local function LoginUI()
    ...
    T.Parent = Main; T.Text = "CSHELL LOGIN v6"; T.Font = Enum.Font.GothamBold; T.TextColor3 = Color3.fromRGB(255, 255, 255); T.TextSize = 35; T.Size = UDim2.new(1, 0, 0, 80); T.BackgroundTransparency = 1; MakeDraggable(T, Main)
