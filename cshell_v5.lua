-- [[ CSHELL HUB PREMIUM v5 - MAGNET VERSION ]] --
repeat wait() until game:IsLoaded()
print("--- CSHELL v5 STARTING ---")
            ...
            pcall(function()
                ...
                if not LocalPlayer.PlayerGui.Main.Quest.Visible then
                    ...
                    if target then
                        ...
                        -- Giữ vị trí ổn định trên cao bãi quái
                        LocalPlayer.Character.HumanoidRootPart.CFrame = q.MPos * CFrame.new(0, 15, 0)
                        
                        -- Fast Attack (Center Screen)
                        game:GetService("VirtualUser"):CaptureController()
                        game:GetService("VirtualUser"):ClickButton1(Vector2.new(9999, 9999)) -- Click tâm màn hình
                    else
                        -- Bay về bãi quái nếu chưa thấy quái
...
local function LoadMainHub()
    ...
    Title.Parent = MainFrame; Title.Text = "CSHELL HUB v5 MAGNET"; Title.Font = Enum.Font.GothamBold; Title.TextColor3 = Color3.fromRGB(255, 255, 255); Title.TextSize = 28; Title.Size = UDim2.new(1, 0, 0, 60); Title.BackgroundTransparency = 1; MakeDraggable(Title, MainFrame)

    local Toggle = Instance.new("TextButton")
    Toggle.Parent = CshellHub; Toggle.Text = "CS"; Toggle.Size = UDim2.new(0, 70, 0, 70); Toggle.Position = UDim2.new(0, 20, 0.5, 0); Toggle.BackgroundColor3 = Color3.fromRGB(50, 120, 255); Toggle.TextColor3 = Color3.fromRGB(255, 255, 255); Toggle.Font = Enum.Font.GothamBold; Toggle.TextSize = 28; Instance.new("UICorner", Toggle).CornerRadius = UDim.new(1, 0); MakeDraggable(Toggle, Toggle)
...
local function LoginUI()
    ...
    T.Parent = Main; T.Text = "CSHELL LOGIN v5"; T.Font = Enum.Font.GothamBold; T.TextColor3 = Color3.fromRGB(255, 255, 255); T.TextSize = 35; T.Size = UDim2.new(1, 0, 0, 80); T.BackgroundTransparency = 1; MakeDraggable(T, Main)
